                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 text-md-end text-center order-1 order-md-2">
                            ...
                            <div v-if="activeTournament.startDate">
                                <p v-if="activeTournament.startDate.toLocaleDateString() == activeTournament.endDate.toLocaleDateString()" class="m-md-0 m-2">
                        ...
                        <div class="col-12 d-flex flex-md-row flex-column justify-content-between text-md-start text-center order-3">
                            ...
                            <p v-if="activeTournament.startDate < new Date()" class="m-md-0 m-2"> Registration is over</p>
