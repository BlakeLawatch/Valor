...
export default {
  setup() {
    const devs = [
      ...
      { name: 'Matt🐧', bio: 'Hey b-b-buddy! I love lifting weights, and running marathons. I also love to catch bugs and go fishing. If you catch me around town, hit me up and we can hang out b-b-buddy!', coverImg: 'https://play-lh.googleusercontent.com/kpDAdLN_1FHjyDd6-u7ijOpGl0w7EBMoE5U7suF7Wt7rnG1gKN6_tyAvxX1foiiB6gaM=w526-h296-rw', picture: 'https://acnhcdn.com/latest/NpcBromide/NpcNmlPgn01.png', github: 'https://github.com/mattwong91' },
