...
export default {
  setup() {
    const devs = [
      ...
      { name: 'Daniel🛢️', bio: 'loves playing minecraft, and is the coolest developer of this website 😎', coverImg: 'https://play-lh.googleusercontent.com/kpDAdLN_1FHjyDd6-u7ijOpGl0w7EBMoE5U7suF7Wt7rnG1gKN6_tyAvxX1foiiB6gaM=w526-h296-rw', picture: 'https://i.pinimg.com/736x/c0/46/42/c04642357bf3797172a866320a933651.jpg', github: 'https://github.com/DanielCoder12' },
