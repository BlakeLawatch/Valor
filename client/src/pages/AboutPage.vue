      ...
      <div class="col-md-9 col-12 order-1 order-md-2">
        <section class="row justify-content-center">
          ...
          <div class="col-10 card-bg mb-3 rounded">
            ...
            <section class="row card-bg justify-content-end align-items-center rounded">
...
export default {
  setup() {
    const devs = [
      ...
      { name: 'Blake🐔', bio: `Coming into this project, I was overwhelmed. Working on a team and figuring it out step by step was quite the accomplishment. I couldn't be more proud of what we created here.`, coverImg: 'https://img.freepik.com/premium-photo/abstract-modern-tech-programming-code-screen-developer-c-programming-language-computer-script-technology-background-software_505353-472.jpg?size=626&ext=jpg&ga=GA1.1.1826414947.1699833600&semt=ais', picture: 'https://media.licdn.com/dms/image/D5603AQHNzLJ7Ustfzg/profile-displayphoto-shrink_400_400/0/1701832643479?e=1707955200&v=beta&t=K8GOS16xWzxLrS0FhfzMuLzz-0QH9rM8XYbXxjnxFnc', github: 'https://github.com/BlakeLawatch?tab=repositories' },
